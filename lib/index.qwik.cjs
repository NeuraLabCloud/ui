...
const NeuralabLogo = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  return /* @__PURE__ */ qwik._jsxQ("a", {
    ...
    target: qwik._fnSignal((p0) => p0.target, [
      props
    ], "p0.target")
    ...
    height: qwik._fnSignal((p0) => p0.h ?? 50, [
      props
    ], "p0.h??50"),
    width: qwik._fnSignal((p0) => p0.w ?? 50, [
      props
    ], "p0.w??50")
  }, null, 3, null), 1, "wq_0");
...
const Avatar = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  ...
  if ((props.animation ?? "none") === "none")
    return /* @__PURE__ */ qwik._jsxQ("img", null, {
      ...
      class: "avatar",
      height: qwik._fnSignal((p0) => p0.h ?? 150, [
        props
      ], "p0.h??150"),
      src: qwik._fnSignal((p0) => p0.src, [
        props
      ], "p0.src"),
      width: qwik._fnSignal((p0) => p0.w ?? 150, [
        props
      ], "p0.w??150")
    }, null, 3, "Sr_0");
  return /* @__PURE__ */ qwik._jsxQ("img", null, {
